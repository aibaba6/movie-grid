...
const css = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .visitor-eye{color:var(--g400);display:block;}
...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="page">
        <div className="hero">
          {visitors !== null && <div className="visitor"><svg className="visitor-eye" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg><span className="visitor-num">{visitors.toLocaleString()}</span></div>}
